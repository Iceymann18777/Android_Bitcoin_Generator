...
.method public constructor <init>(Landroidx/appcompat/widget/w;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/h0;->a(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/h0;->a(Z)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/h0;->f(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/h0;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    return-void
.end method

.method static synthetic a(Landroidx/appcompat/widget/w$c;)V
    .registers 1

    invoke-super {p0}, Landroidx/appcompat/widget/h0;->f()V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/h0;->a(Landroid/widget/ListAdapter;)V
...
.method b(Landroid/view/View;)Z
    ...
    invoke-static {p1}, La/g/l/r;->w(Landroid/view/View;)Z
...
.method public f()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/w$c;->l()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/h0;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/h0;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method l()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/h0;->c()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/z0;->a(Landroid/view/View;)Z
    ...
    :goto_7e
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/h0;->b(I)V

    goto :goto_85

    :cond_82
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/h0;->b(I)V

    :goto_85
    iget-object v4, p0, Landroidx/appcompat/widget/w$c;->M:Landroidx/appcompat/widget/w;

    invoke-static {v4}, Landroidx/appcompat/widget/z0;->a(Landroid/view/View;)Z
